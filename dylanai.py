...
"""Moves 74411
dir test : 0.5110452999999961
perpendicular : 0.6423129999999642
get states : 2.644907399999557
parallel : 0.5654246000001208
total : 10.1112493"""
...
class Dylanai(Player):
    ...
    def setup(self):
        ...
        self.remaining_w = 100
        self.e_remaining_w = -100

        self.avg_center_dist_w = -5
    ...
    def rate_game_state(self, game_state):
       ...
       #print("avg_center_dist: ", avg_center_dist, "\ne_avg_center_dist: ", e_avg_center_dist, "\nremaining: ", remaining, "\ne_remaining: ", e_remaining, "\non_rim: ", on_rim, "\ne_on_rim: ", e_on_rim)
